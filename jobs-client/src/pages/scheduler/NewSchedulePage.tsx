    ...
    try {
     ...
     await dispatch(createScheduledJob({
      ...
      toast({
        ...
        description: `Schedule "${data.name}" has been created successfully`,
      });
    ...
    <div className="container p-6 mx-auto">
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Schedule a job to run automatically based on a schedule
        </p>
      </div>
      ...
      <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 max-w-2xl">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Enter the details for the job you want to schedule
          </p>
        </div>
