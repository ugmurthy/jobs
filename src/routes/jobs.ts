 ...
 * Submit a new job
 */
router.post('/:queueName/submit', authenticate, validateQueue, async (req: Request, res: Response, next: Function) => {
    try {
 ...
 */
router.get('/:queueName/job/:jobId', authenticate, validateQueue, async (req: Request, res: Response, next: Function) => {
    try {
 ...
 */
router.get('/:queueName', authenticate, validateQueue, async (req: Request, res: Response, next: Function) => {
    try {
        const { queueName } = req.params;
 ...
 */
router.delete('/:queueName/job/:jobId', authenticate, validateQueue, async (req: Request, res: Response, next: Function) => {
    try {
        const { queueName, jobId } = req.params;
        const userId = req.user?.userId;
