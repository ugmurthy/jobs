...
describe('FlowService', () => {
    ...
    describe('createFlow', () => {
        it('should create flow with consistent flowId', async () => {
            ...
            // Mock Prisma calls
            prisma.flow.create.mockResolvedValue(mockFlow);
            prisma.flow.findUnique.mockResolvedValue(mockFlow);
            prisma.flow.update.mockResolvedValue(mockFlow);
    ...
    describe('updateJobProgress', () => {
        ...
        it('should determine correct flow status based on job statuses', async () => {
            ...
            const mockFlow = {
                ...
                progress: {
                    jobs: {
                        'job_123': { status: 'completed' },
                        'job_456': { status: 'active' }
                    },
    ...
    describe('getFlows', () => {
        it('should return all flows for user', async () => {
            ...
            prisma.flow.findMany.mockResolvedValue(mockFlows);
